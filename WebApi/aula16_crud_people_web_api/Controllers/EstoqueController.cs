...
{   
    ...
    public class EstoqueController : ControllerBase
    {
        ...
        {
            _repository = new aula12_ef_continuacao.Data.Repositories.EstoqueRepository();
        }
        [HttpGet]
        ...
        [HttpPost]
        public IActionResult Post([FromBody]Estoque item)
        {
        ...
        [HttpPut]
        public IActionResult Put([FromBody]Estoque item)
        {
            _repository.Update(item);
            return Ok(new {
                statusCode = 200,
                message = "Estoque autalizado com sucesso.",
                item});
        }
